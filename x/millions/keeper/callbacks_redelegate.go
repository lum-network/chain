...
func RedelegateCallback(k Keeper, ctx sdk.Context, packet channeltypes.Packet, ackResponse *icacallbackstypes.AcknowledgementResponse, args []byte) error {
	...
	if ackResponse.Status == icacallbackstypes.AckResponseStatus_TIMEOUT {
		...
		return k.OnRedelegateOnNativeChainCompleted(ctx, redelegateCallback.GetPoolId(), redelegateCallback.GetOperatorAddress(), redelegateCallback.GetSplitDelegations(), true)
		...
		return k.OnRedelegateOnNativeChainCompleted(ctx, redelegateCallback.GetPoolId(), redelegateCallback.GetOperatorAddress(), redelegateCallback.GetSplitDelegations(), false)
	}
	return nil
}
