...
type LegacyUndelegateCallback struct {
	PoolId           uint64             `protobuf:"varint,1,opt,name=pool_id,json=poolId,proto3" json:"pool_id,omitempty"`
	WithdrawalId     uint64             `protobuf:"varint,2,opt,name=withdrawal_id,json=withdrawalId,proto3" json:"withdrawal_id,omitempty"`
	SplitDelegations []*SplitDelegation `protobuf:"bytes,3,rep,name=split_delegations,json=splitDelegations,proto3" json:"split_delegations,omitempty"`
}

func (m *LegacyUndelegateCallback) Reset()         { *m = LegacyUndelegateCallback{} }
func (m *LegacyUndelegateCallback) String() string { return proto.CompactTextString(m) }
func (*LegacyUndelegateCallback) ProtoMessage()    {}
func (*LegacyUndelegateCallback) Descriptor() ([]byte, []int) {
	return fileDescriptor_e5bf5a3c4f1710be, []int{2}
}
func (m *LegacyUndelegateCallback) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LegacyUndelegateCallback) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LegacyUndelegateCallback.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LegacyUndelegateCallback) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LegacyUndelegateCallback.Merge(m, src)
}
func (m *LegacyUndelegateCallback) XXX_Size() int {
	return m.Size()
}
func (m *LegacyUndelegateCallback) XXX_DiscardUnknown() {
	xxx_messageInfo_LegacyUndelegateCallback.DiscardUnknown(m)
}

var xxx_messageInfo_LegacyUndelegateCallback proto.InternalMessageInfo

func (m *LegacyUndelegateCallback) GetPoolId() uint64 {
	if m != nil {
		return m.PoolId
	}
	return 0
...
func (m *LegacyUndelegateCallback) GetWithdrawalId() uint64 {
	if m != nil {
...
func (m *LegacyUndelegateCallback) GetSplitDelegations() []*SplitDelegation {
	if m != nil {
		return m.SplitDelegations
	}
	return nil
...
func (*BankSendCallback) Descriptor() ([]byte, []int) {
	return fileDescriptor_e5bf5a3c4f1710be, []int{9}
}
...
func init() {
	...
	proto.RegisterType((*LegacyUndelegateCallback)(nil), "lum.network.millions.LegacyUndelegateCallback")
...
var fileDescriptor_e5bf5a3c4f1710be = []byte{
	...
	,
}
...
func (m *LegacyUndelegateCallback) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LegacyUndelegateCallback) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LegacyUndelegateCallback) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *LegacyUndelegateCallback) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LegacyUndelegateCallback) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LegacyUndelegateCallback: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LegacyUndelegateCallback: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
