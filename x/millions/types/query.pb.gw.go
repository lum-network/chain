...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"lum-network", "millions", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Pools_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"lum-network", "millions", "pools"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Pool_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"lum-network", "millions", "pools", "pool_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Deposits_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"lum-network", "millions", "deposits"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PoolDeposits_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"lum-network", "millions", "deposits", "pool_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PoolDeposit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"lum-network", "millions", "deposits", "pool_id", "deposit_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AccountDeposits_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"lum-network", "millions", "account", "depositor_address", "deposits"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AccountPoolDeposits_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"lum-network", "millions", "account", "depositor_address", "deposits", "pool_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Draws_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"lum-network", "millions", "draws"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PoolDraws_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"lum-network", "millions", "draws", "pool_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PoolDraw_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"lum-network", "millions", "draws", "pool_id", "draw_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Prizes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"lum-network", "millions", "prizes"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PoolPrizes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"lum-network", "millions", "prizes", "pool_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PoolDrawPrizes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"lum-network", "millions", "prizes", "pool_id", "draw_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PoolDrawPrize_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"lum-network", "millions", "prizes", "pool_id", "draw_id", "prize_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AccountPrizes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"lum-network", "millions", "account", "winner_address", "prizes"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AccountPoolPrizes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"lum-network", "millions", "account", "winner_address", "prizes", "pool_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AccountPoolDrawPrizes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4, 1, 0, 4, 1, 5, 5, 1, 0, 4, 1, 5, 6}, []string{"lum-network", "millions", "account", "winner_address", "prizes", "pool_id", "draw_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Withdrawals_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"lum-network", "millions", "withdrawals"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PoolWithdrawals_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"lum-network", "millions", "withdrawals", "pool_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PoolWithdrawal_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"lum-network", "millions", "withdrawals", "pool_id", "withdrawal_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AccountWithdrawals_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"lum-network", "millions", "account", "depositor_address", "withdrawals"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AccountPoolWithdrawals_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"lum-network", "millions", "account", "depositor_address", "withdrawals", "pool_id"}, "", runtime.AssumeColonVerbOpt(true)))
)
