...
// source: lumnetwork/chain/millions/deposit.proto
...
func (DepositState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_478e40a185c7ccc6, []int{0}
}

type Deposit struct {
	PoolId           uint64       `protobuf:"varint,1,opt,name=pool_id,json=poolId,proto3" json:"pool_id,omitempty"`
	DepositId        uint64       `protobuf:"varint,2,opt,name=deposit_id,json=depositId,proto3" json:"deposit_id,omitempty"`
	State            DepositState `protobuf:"varint,3,opt,name=state,proto3,enum=lumnetwork.chain.millions.DepositState" json:"state,omitempty"`
	ErrorState       DepositState `protobuf:"varint,4,opt,name=error_state,json=errorState,proto3,enum=lumnetwork.chain.millions.DepositState" json:"error_state,omitempty"`
...
func init() {
	proto.RegisterEnum("lumnetwork.chain.millions.DepositState", DepositState_name, DepositState_value)
	proto.RegisterType((*Deposit)(nil), "lumnetwork.chain.millions.Deposit")
}

func init() {
	proto.RegisterFile("lumnetwork/chain/millions/deposit.proto", fileDescriptor_478e40a185c7ccc6)
}

var fileDescriptor_478e40a185c7ccc6 = []byte{
	// 661 bytes of a gzipped FileDescriptorProto
	,
}
