...
// source: lumnetwork/millions/gov.proto
...
type ProposalRegisterPool struct {
	...
	PoolType            PoolType                               `protobuf:"varint,14,opt,name=pool_type,json=poolType,proto3,enum=lumnetwork.millions.PoolType" json:"pool_type,omitempty"`
}
...
func (*ProposalRegisterPool) Descriptor() ([]byte, []int) {
	return fileDescriptor_f354bb0b2ead3be2, []int{0}
}
...
type ProposalUpdatePool struct {
	...
	State            PoolState                               `protobuf:"varint,8,opt,name=state,proto3,enum=lumnetwork.millions.PoolState" json:"state,omitempty"`
}
...
func (*ProposalUpdatePool) Descriptor() ([]byte, []int) {
	return fileDescriptor_f354bb0b2ead3be2, []int{1}
}
...
func (*ProposalUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_f354bb0b2ead3be2, []int{2}
}
...
func init() {
	proto.RegisterType((*ProposalRegisterPool)(nil), "lumnetwork.millions.ProposalRegisterPool")
	proto.RegisterType((*ProposalUpdatePool)(nil), "lumnetwork.millions.ProposalUpdatePool")
	proto.RegisterType((*ProposalUpdateParams)(nil), "lumnetwork.millions.ProposalUpdateParams")
}

func init() { proto.RegisterFile("lumnetwork/millions/gov.proto", fileDescriptor_f354bb0b2ead3be2) }

var fileDescriptor_f354bb0b2ead3be2 = []byte{
	// 863 bytes of a gzipped FileDescriptorProto
	,
}
