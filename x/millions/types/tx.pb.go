...
type MsgClaimPrize struct {
	...
	WinnerAddress  string `protobuf:"bytes,4,opt,name=winner_address,json=winnerAddress,proto3" json:"winner_address,omitempty"`
	IsAutoCompound bool   `protobuf:"varint,5,opt,name=is_auto_compound,json=isAutoCompound,proto3" json:"is_auto_compound,omitempty"`
	IsSponsor      bool   `protobuf:"varint,6,opt,name=is_sponsor,json=isSponsor,proto3" json:"is_sponsor,omitempty"`
}
...
func (m *MsgClaimPrize) GetIsAutoCompound() bool {
	if m != nil {
		return m.IsAutoCompound
	}
	return false
}

func (m *MsgClaimPrize) GetIsSponsor() bool {
	if m != nil {
		return m.IsSponsor
	}
	return false
...
var fileDescriptor_13b6da814e999511 = []byte{
	...
	,
}
...
func (m *MsgClaimPrize) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsAutoCompound", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
