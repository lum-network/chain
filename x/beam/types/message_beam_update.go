...
func NewMsgUpdateBeam(updater, id string, amount *sdk.Coin, status BeamState, data *BeamData, cancelReason string, hideContent bool, closesAtBlock, claimExpiresAtBlock int32) *MsgUpdateBeam {
