...
// source: lumnetwork/chain/beam/query.proto
...
func (*QueryGetBeamRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_488f9bf5ea782a05, []int{0}
}
...
func (*QueryGetBeamResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_488f9bf5ea782a05, []int{1}
}
...
type QueryFetchBeamsRequest struct {
	...
	State      BeamState          `protobuf:"varint,2,opt,name=state,proto3,enum=lumnetwork.chain.beam.BeamState" json:"state,omitempty"`
}
...
func (*QueryFetchBeamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_488f9bf5ea782a05, []int{2}
}
...
func (*QueryFetchBeamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_488f9bf5ea782a05, []int{3}
}
...
func (*QueryFetchBeamsOpenQueueRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_488f9bf5ea782a05, []int{4}
}
...
func (*QueryFetchBeamsOpenQueueResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_488f9bf5ea782a05, []int{5}
}
...
func init() {
	proto.RegisterType((*QueryGetBeamRequest)(nil), "lumnetwork.chain.beam.QueryGetBeamRequest")
	proto.RegisterType((*QueryGetBeamResponse)(nil), "lumnetwork.chain.beam.QueryGetBeamResponse")
	proto.RegisterType((*QueryFetchBeamsRequest)(nil), "lumnetwork.chain.beam.QueryFetchBeamsRequest")
	proto.RegisterType((*QueryFetchBeamsResponse)(nil), "lumnetwork.chain.beam.QueryFetchBeamsResponse")
	proto.RegisterType((*QueryFetchBeamsOpenQueueRequest)(nil), "lumnetwork.chain.beam.QueryFetchBeamsOpenQueueRequest")
	proto.RegisterType((*QueryFetchBeamsOpenQueueResponse)(nil), "lumnetwork.chain.beam.QueryFetchBeamsOpenQueueResponse")
}

func init() { proto.RegisterFile("lumnetwork/chain/beam/query.proto", fileDescriptor_488f9bf5ea782a05) }

var fileDescriptor_488f9bf5ea782a05 = []byte{
	// 532 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *queryClient) Beam(ctx context.Context, in *QueryGetBeamRequest, opts ...grpc.CallOption) (*QueryGetBeamResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lumnetwork.chain.beam.Query/Beam", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Beams(ctx context.Context, in *QueryFetchBeamsRequest, opts ...grpc.CallOption) (*QueryFetchBeamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lumnetwork.chain.beam.Query/Beams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) BeamsOpenQueue(ctx context.Context, in *QueryFetchBeamsOpenQueueRequest, opts ...grpc.CallOption) (*QueryFetchBeamsOpenQueueResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lumnetwork.chain.beam.Query/BeamsOpenQueue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Beam_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lumnetwork.chain.beam.Query/Beam",
	}
...
func _Query_Beams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lumnetwork.chain.beam.Query/Beams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_BeamsOpenQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lumnetwork.chain.beam.Query/BeamsOpenQueue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "lumnetwork.chain.beam.Query",
	...
	Metadata: "lumnetwork/chain/beam/query.proto",
}
