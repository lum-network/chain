...
var (
	pattern_Query_EpochInfos_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"lum-network", "epochs"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_CurrentEpoch_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"lum-network", "epochs", "current_epoch"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_EpochInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"lum-network", "epochs", "epoch_info"}, "", runtime.AssumeColonVerbOpt(false)))
)
