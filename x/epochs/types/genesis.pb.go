...
// source: lum/network/epochs/genesis.proto
...
func (*EpochInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_38d0e7c57f4b094c, []int{0}
}
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return fileDescriptor_38d0e7c57f4b094c, []int{1}
}
...
func init() {
	proto.RegisterType((*EpochInfo)(nil), "lum.network.epochs.EpochInfo")
	proto.RegisterType((*GenesisState)(nil), "lum.network.epochs.GenesisState")
}

func init() { proto.RegisterFile("lum/network/epochs/genesis.proto", fileDescriptor_38d0e7c57f4b094c) }

var fileDescriptor_38d0e7c57f4b094c = []byte{
	// 470 bytes of a gzipped FileDescriptorProto
	,
}
