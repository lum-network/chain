...
import (
	...
	"github.com/lum-network/chain/x/icqueries/client/cli"
...
func (AppModuleBasic) ValidateGenesis(_ codec.JSONCodec, config client.TxEncodingConfig, bz json.RawMessage) error {
	return nil
}
...
func (AppModule) ConsensusVersion() uint64 { return types.ModuleVersion }
