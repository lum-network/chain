...
var (
	...
	moduleAccountPermissions = []*authmodulev1.ModuleAccountPermission{
		...
		{Account: beamtypes.ModuleName},
		{Account: icqueriestypes.ModuleName},
		{Account: airdroptypes.ModuleName, Permissions: []string{authtypes.Minter, authtypes.Burner}},
		{Account: dfracttypes.ModuleName, Permissions: []string{authtypes.Minter, authtypes.Burner}},
		{Account: millionstypes.ModuleName, Permissions: []string{authtypes.Minter, authtypes.Burner, authtypes.Staking}},
	}
		...
		Modules: []*appv1alpha1.ModuleConfig{
			{
				...
				Config: appconfig.WrapAny(&runtimev1alpha1.Module{
					...
					OverrideStoreKeys: []*runtimev1alpha1.StoreKeyConfig{
						{
							ModuleName: icacontrollertypes.SubModuleName,
							KvStoreKey: ICAControllerCustomStoreKey,
						},
					},
			...
			},
			{
				...
				Config: appconfig.WrapAny(&bankmodulev1.Module{
					BlockedModuleAccountsOverride: blockedModuleAccountAddresses,
				}),
			},
			{
